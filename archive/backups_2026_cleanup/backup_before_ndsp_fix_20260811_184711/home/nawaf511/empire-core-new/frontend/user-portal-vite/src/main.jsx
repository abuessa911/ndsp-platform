...
import { CompletedDecisionsPanelV37 } from "./components/CompletedDecisionsPanelV37";
import { ApplicationShell } from "./components/layout/ApplicationShell";
import { AuthGate } from "./auth/AuthGate";
import { PortalPageRouterV1 } from "./components/PortalPageRouterV1";
    ...
    <ApplicationShell>
      ...
      <header className="topbar">
        <div>
          ...
          <div className="subtitle">منصة دعم القرار</div>
        </div>
