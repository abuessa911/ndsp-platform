...
for path in \
  ...
  /var/www/ndsp-admin \
  /var/www/ndsp.app \
  /home/nawaf511/empire-core-v5-1-1-clean/frontend/public-site/dist; do
  if [[ -L "$path" ]]; then
...
for root in /var/www/ndsp-my-portal /var/www/ndsp-admin /home/nawaf511/empire-core-v5-1-1-clean/frontend/public-site/dist; do
