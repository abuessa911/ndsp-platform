(function () {
  ...
  var layerDescriptions = {
    ar: {
      ...
      "NDSP-CORE-L08": "NMP وقيمة الالتقاء الحرجة.",
      ...
      "NDSP-CORE-L13": "الإشارة الذهبية وحالة اكتمال مدخلاتها.",
      "NDSP-CORE-L14": "الإشارة الذهبية المعززة وشروطها الإضافية.",
    ...
    en: {
      ...
      "NDSP-CORE-L08": "NMP and critical confluence value.",
      ...
      "NDSP-CORE-L13": "Golden Signal and input completeness.",
      "NDSP-CORE-L14": "Enhanced Golden Signal and extra conditions.",
  ...
  function copy() {
    if (language() === "en") {
      return {
        platform: "NDSP — Decision Support Platform",
