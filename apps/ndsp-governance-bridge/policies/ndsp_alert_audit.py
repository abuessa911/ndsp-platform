...
AUDIT_PATH = Path(os.getenv("NDSP_ALERT_AUDIT_FILE", "/home/nawaf511/.local/share/ndsp/runtime-data/backend/runtime/alert_audit_log.jsonl"))
STATE_PATH = Path(os.getenv("NDSP_ALERT_STATE_FILE", "/home/nawaf511/.local/share/ndsp/runtime-data/backend/runtime/alert_spam_state.json"))
