...
DATE=2026-07-08T06:54:52+02:00
...
NO_RESTART=1
NO_REBOOT=1
ARTIFACT_DIR=/tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452
...
└────┴────────────────┴─────────────┴─────────┴─────────┴──────────┴────────┴──────┴───────────┴──────────┴──────────┴──────────┴──────────┘
[1m[36mhost metrics[39m[22m | [1mcpu[22m: [32m9%[39m | [1mram usage[22m: [32m9.9%[39m | [1mlo[22m: ⇓ [32m0.001mb/s[39m ⇑ [32m0.001mb/s[39m | [1meth0[22m: ⇓ [32m0.017mb/s[39m ⇑ [32m0.001mb/s[39m | [1mdisk[22m: ⇓ 0mb/s ⇑ [32m0.195mb/s[39m [90m/[39m [1m[33m81.99%[39m[22m |
API_HEALTH_HTTP=200
...
3532162 postgres       41:52 /opt/ndsp-change-password-gateway/venv/bin/python3 /opt/ndsp-change-password-gateway/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9069
3532165 nawaf511       41:52 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9065
3532173 root           41:51 /opt/ndsp-decision-package-v1/venv/bin/python3 /opt/ndsp-decision-package-v1/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9061
3532176 postgres       41:51 /opt/ndsp-current-user-display/.venv/bin/python3 /opt/ndsp-current-user-display/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9074
3532178 nawaf511       41:51 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9076
3532200 root           41:50 /usr/bin/python3 -m uvicorn main:app --host 127.0.0.1 --port 9066
3532221 root           41:50 /usr/bin/python3 -m uvicorn app:app --host 127.0.0.1 --port 9068
3708547 root           00:00 grep -E ndip-api-new|uvicorn|gunicorn|streamlit|signal_engine|run_watcher|app.main|server:app
3708548 root           00:00 tee /tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452/ndip-api-new/process_matches.txt
...
LISTEN 0      511          0.0.0.0:3000      0.0.0.0:*    users:(("MainThread",pid=1099167,fd=21))                                                                                                                                                                                                                        
LISTEN 0      511        127.0.0.1:8097      0.0.0.0:*    users:(("node",pid=1389,fd=32))                                                                                                                                                                                                                                 
3532162 postgres       41:54 /opt/ndsp-change-password-gateway/venv/bin/python3 /opt/ndsp-change-password-gateway/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9069
3532165 nawaf511       41:54 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9065
3532173 root           41:54 /opt/ndsp-decision-package-v1/venv/bin/python3 /opt/ndsp-decision-package-v1/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9061
3532176 postgres       41:54 /opt/ndsp-current-user-display/.venv/bin/python3 /opt/ndsp-current-user-display/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9074
3532178 nawaf511       41:54 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9076
3532200 root           41:53 /usr/bin/python3 -m uvicorn main:app --host 127.0.0.1 --port 9066
3532221 root           41:53 /usr/bin/python3 -m uvicorn app:app --host 127.0.0.1 --port 9068
3708746 root           00:00 grep -E signal-engine|uvicorn|gunicorn|streamlit|signal_engine|run_watcher|app.main|server:app
3708747 root           00:00 tee /tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452/signal-engine/process_matches.txt
...
LISTEN 0      511          0.0.0.0:3000      0.0.0.0:*    users:(("MainThread",pid=1099167,fd=21))                                                                                                                                                                                                                        
LISTEN 0      511        127.0.0.1:8097      0.0.0.0:*    users:(("node",pid=1389,fd=32))                                                                                                                                                                                                                                 
3532162 postgres       41:57 /opt/ndsp-change-password-gateway/venv/bin/python3 /opt/ndsp-change-password-gateway/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9069
3532165 nawaf511       41:57 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9065
3532173 root           41:57 /opt/ndsp-decision-package-v1/venv/bin/python3 /opt/ndsp-decision-package-v1/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9061
3532176 postgres       41:57 /opt/ndsp-current-user-display/.venv/bin/python3 /opt/ndsp-current-user-display/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9074
3532178 nawaf511       41:57 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9076
3532200 root           41:56 /usr/bin/python3 -m uvicorn main:app --host 127.0.0.1 --port 9066
3532221 root           41:56 /usr/bin/python3 -m uvicorn app:app --host 127.0.0.1 --port 9068
3708762 nawaf511       00:02 /home/nawaf511/empire-core-new/backend/venv/bin/python /home/nawaf511/empire-core-new/backend/venv/bin/gunicorn app.main:app -k uvicorn.workers.UvicornWorker --bind 127.0.0.1:9002 --workers 4 --timeout 120
3708945 root           00:00 grep -E subscription-watcher|uvicorn|gunicorn|streamlit|signal_engine|run_watcher|app.main|server:app
3708946 root           00:00 tee /tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452/subscription-watcher/process_matches.txt
...
LISTEN 0      511          0.0.0.0:3000      0.0.0.0:*    users:(("MainThread",pid=1099167,fd=21))                                                                                                                                                                                                                        
LISTEN 0      511        127.0.0.1:8097      0.0.0.0:*    users:(("node",pid=1389,fd=32))                                                                                                                                                                                                                                 
3532162 postgres       42:00 /opt/ndsp-change-password-gateway/venv/bin/python3 /opt/ndsp-change-password-gateway/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9069
3532165 nawaf511       42:00 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-layers-api/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9065
3532173 root           42:00 /opt/ndsp-decision-package-v1/venv/bin/python3 /opt/ndsp-decision-package-v1/venv/bin/uvicorn app:app --host 127.0.0.1 --port 9061
3532176 postgres       42:00 /opt/ndsp-current-user-display/.venv/bin/python3 /opt/ndsp-current-user-display/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9074
3532178 nawaf511       42:00 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/python3 /home/nawaf511/empire-core-new/apps/ndsp-raw-cot-gateway/.venv/bin/uvicorn app:app --host 127.0.0.1 --port 9076
3532200 root           41:59 /usr/bin/python3 -m uvicorn main:app --host 127.0.0.1 --port 9066
3532221 root           41:59 /usr/bin/python3 -m uvicorn app:app --host 127.0.0.1 --port 9068
3709141 root           00:00 grep -E testapp|uvicorn|gunicorn|streamlit|signal_engine|run_watcher|app.main|server:app
3709142 root           00:00 tee /tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452/testapp/process_matches.txt
...
│ [1m[36m0[39m[22m  │ ndsp-portal    │ default     │ 0.39.7  │ [7m[1mfork[22m[27m    │ 1099070  │ 2D     │ 0    │ [32m[1monline[22m[39m    │ 0%       │ 79.1mb   │ [1mnawaf511[22m │ [90mdisabled[39m │
└────┴────────────────┴─────────────┴─────────┴─────────┴──────────┴────────┴──────┴───────────┴──────────┴──────────┴──────────┴──────────┘
[1m[36mhost metrics[39m[22m | [1mcpu[22m: [32m14.4%[39m | [1mram usage[22m: [32m10.1%[39m | [1mlo[22m: ⇓ [32m0.016mb/s[39m ⇑ [32m0.016mb/s[39m | [1meth0[22m: ⇓ [32m0.182mb/s[39m ⇑ [32m0.008mb/s[39m | [1mdisk[22m: ⇓ 0mb/s ⇑ [32m0.182mb/s[39m [90m/[39m [1m[33m81.99%[39m[22m |
API_HEALTH_HTTP=200
QUALITY_LIVE_HTTP=200
MY_NDSP_HTTP=200

FINAL_STATUS=P2_HOLD_REVIEW_SERVICES_DEEP_AUDIT_READONLY_DONE
REPORT=docs/05-runbooks/NDSP_P2_HOLD_REVIEW_SERVICES_DEEP_AUDIT_READONLY_20260708_065452.md
ARTIFACT_DIR=/tmp/NDSP_P2_HOLD_REVIEW_DEEP_AUDIT_20260708_065452
