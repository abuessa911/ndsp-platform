# NDSP Mobile Menu Link Layout Patch V4
DATE=2026-07-07T19:45:53+02:00
MODE=CSS_ONLY
CSS=/var/www/ndsp-my/assets/ndsp-global-menu.css
BACKUP=/home/nawaf511/ndsp_backups/NDSP_MOBILE_MENU_LINK_LAYOUT_V4_20260707_194553

## Purpose
- Fix menu link internal layout.
- Keep text visible inside the panel.
- Stop labels from being clipped outside the menu.
- Do not modify JS, API, PM2, Nginx, radar, or disclaimer.
...
== Verify marker ==
518:/* NDSP_MOBILE_MENU_LINK_LAYOUT_V4_START */
619:/* NDSP_MOBILE_MENU_LINK_LAYOUT_V4_END */

== Post Patch Test ==
# NDSP Post Patch Test Report
DATE=20260707_194554
...
└────┴────────────────┴─────────────┴─────────┴─────────┴──────────┴────────┴──────┴───────────┴──────────┴──────────┴──────────┴──────────┘
host metrics | cpu: 12.1% | ram usage: 9.9% | lo: ⇓ 0.004mb/s ⇑ 0.004mb/s | eth0: ⇓ 0.094mb/s ⇑ 0.004mb/s | disk: ⇓ 0.017mb/s ⇑ 0.27mb/s / 81.95% |

FINAL_STATUS=POST_PATCH_TEST_OK
REPORT=/home/nawaf511/empire-core-new/docs/05-runbooks/NDSP_POST_PATCH_TEST_20260707_194554.md
FINAL_STATUS=MOBILE_MENU_LINK_LAYOUT_V4_PATCH_APPLIED
