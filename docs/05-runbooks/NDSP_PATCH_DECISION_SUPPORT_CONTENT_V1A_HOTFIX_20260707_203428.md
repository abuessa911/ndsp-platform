# NDSP Decision Support Content V1A Hotfix
DATE=2026-07-07T20:34:28+02:00
...
## Purpose
- Remove wording that triggers unsafe execution-order scan.
- Keep the content block.
- No API, PM2, Nginx, JS, route, or backend changes.
...
7:<!-- NDSP_DECISION_SUPPORT_CONTENT_V1A_HOTFIX -->
55:<!-- NDSP_DECISION_SUPPORT_CONTENT_V1_END -->
--- decision-center.html ---
5:<!-- NDSP_DECISION_SUPPORT_CONTENT_V1_START -->
6:<!-- NDSP_DECISION_SUPPORT_CONTENT_V1A_HOTFIX -->
...
FINAL_STATUS=DECISION_SUPPORT_CONTENT_V1A_HOTFIX_APPLIED
