...
# NDSP — Commercial Staging Source Deployment V1.6

- Date: 2026-07-30T08:20:57+02:00
...
- Report: /home/nawaf511/empire-core-new/docs/05-runbooks/NDSP_COMMERCIAL_STAGING_SOURCE_DEPLOY_V1_6_20260730_082056/REPORT.md
...
- **FINAL:** `FAIL` — STAGING_DB_OR_ROLE_ALREADY_EXISTS:db=t:role=t

## Rollback

- Reason: STAGING_DB_OR_ROLE_ALREADY_EXISTS:db=t:role=t
- Production database writes: NO
- Production row-data copy: NO
- Nginx/portal changes: NO
- Production service restart: NO
- FINAL_STATUS: `NDSP_COMMERCIAL_STAGING_SOURCE_DEPLOY_V1_6_FAILED`
- REPORT: /home/nawaf511/empire-core-new/docs/05-runbooks/NDSP_COMMERCIAL_STAGING_SOURCE_DEPLOY_V1_6_20260730_082056/REPORT.md
