...
// NDSP_EXTRA_ROUTES_V2
(function() {
  const { installSeatRoutes, installMarketRoutes, startBinanceFeed, startYahooFeed, startFxcmFeed } = require('./ndsp_extra_routes');
  installSeatRoutes(app, auth);
  installMarketRoutes(app);
  startBinanceFeed();
  startYahooFeed();
  startFxcmFeed();
  console.log('[NDSP-Extra] routes + feeds installed');
})();
