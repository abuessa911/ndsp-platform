...
out1 = govern_decision_output(payload_exposed, package="elite")

assert out1["governance"]["MODE"] == "DECISION_ACTIVE"
assert out1["governance"]["EXECUTION_POLICY"] == "EXECUTION_SANITIZED"
assert out1["governance"]["DIRECT_TRADE_EXECUTION"] is False
assert out1["governance"]["PUBLIC_OUTPUT_SANITIZED"] is True
assert out1["governance"]["FRONTEND_IS_DISPLAY_ONLY"] is True
assert out1["governance"]["BACKEND_IS_DECISION_AUTHORITY"] is True
assert out1["governance"]["RAW_LOGIC_EXPOSED"] is False
assert out1["governance"]["FORMULAS_EXPOSED"] is False
assert out1["governance"]["WEIGHTS_EXPOSED"] is False
assert out1["governance"]["HIDDEN_LAYER_NAMES_EXPOSED"] is False
...
assert out1["public_safe"] is True
assert_safe(out1)

payload_non_explicit = {
    "ok": True,
    "symbol": "XAUUSD",
    "market": "metals",
    "timeframe": "4h",
...
out2 = govern_decision_output(payload_non_explicit, package="pro")
...
print("FINAL_STATUS=NDSP_PYTHON_TDL_V2_KEYERROR_FIX_TEST_OK")
